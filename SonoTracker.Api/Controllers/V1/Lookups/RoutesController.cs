...
namespace SonoTracker.Api.Controllers.V1.Lookups
{
    ...
    [Authorize]
    public class RoutesController(IRouteService routeService) : BaseController
    {
        /// <summary>
        /// Get By Id 
        /// </summary>
        ...
        public async Task<IFinalResult> GetEditAsync(string id, CancellationToken cancellationToken = default)
                                        => await routeService.GetByIdForEditAsync(id, cancellationToken);
        ...
        {
            IFinalResult res = await routeService.GetAllAsync(cancellationToken: cancellationToken);
            return Ok(res);
        }
        ...
        [HttpPost("getPaged")]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status200OK)]
        public async Task<ActionResult<PagingResult>> GetPagedAsync([FromBody] BaseParam<RouteFilter> filter, CancellationToken cancellationToken = default)
        {
            PagingResult res = await routeService.GetAllPagedAsync(filter, cancellationToken);
            return Ok(res);
        }
        ...
        {
            PagingResult res = await routeService.GetDropDownAsync(filter, cancellationToken);
            return Ok(res);
        }
        ...
        public async Task<ActionResult<IFinalResult>> AddAsync([FromBody] AddRouteDto dto, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await routeService.AddAsync(dto, cancellationToken);
        ...
        [ProducesResponseType<IFinalResult>(StatusCodes.Status400BadRequest)]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status409Conflict)]
        public async Task<ActionResult<IFinalResult>> UpdateAsync([FromBody] AddRouteDto model, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await routeService.UpdateAsync(model, cancellationToken);
        ...
        {
            IFinalResult res = await routeService.DeleteAsync(id, cancellationToken);
        ...
        {
            IFinalResult res = await routeService.DeleteSoftAsync(id, cancellationToken);
