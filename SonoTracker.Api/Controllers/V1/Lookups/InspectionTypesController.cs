...
namespace SonoTracker.Api.Controllers.V1.Lookups
{
    ...
    public class InspectionTypesController(IInspectionTypeService inspectionTypeService) : BaseController
    {
        ...
        {
            IFinalResult res = await inspectionTypeService.GetAllAsync(cancellationToken: cancellationToken);
            return Ok(res);
        }
        ...
        public async Task<ActionResult<IFinalResult>> AddAsync([FromBody] AddInspectionTypeDto dto, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await inspectionTypeService.AddAsync(dto, cancellationToken);
        ...
        [ProducesResponseType<IFinalResult>(StatusCodes.Status400BadRequest)]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status409Conflict)]
        public async Task<ActionResult<IFinalResult>> UpdateAsync([FromBody] AddInspectionTypeDto model, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await inspectionTypeService.UpdateAsync(model, cancellationToken);
        ...
        {
            IFinalResult res = await inspectionTypeService.DeleteAsync(id, cancellationToken);
        ...
        {
            IFinalResult res = await inspectionTypeService.DeleteSoftAsync(id, cancellationToken);
