...
namespace SonoTracker.Api.Controllers.V1.Lookups
{
    ...
    public class GeoPointsController(IGeoPointService geoPointService) : BaseController
    {
        ...
        {
            IFinalResult res = await geoPointService.GetByIdAsync(id, cancellationToken);
        ...
        //                                => await geoPointService.GetByIdForEditAsync(id, cancellationToken);
        ...
        {
            IFinalResult res = await geoPointService.GetAllAsync(cancellationToken: cancellationToken);
            return Ok(res);
        }
        ...
        public async Task<ActionResult<IFinalResult>> AddAsync([FromBody] AddGeoPointDto dto, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await geoPointService.AddAsync(dto, cancellationToken);
        ...
        [ProducesResponseType<IFinalResult>(StatusCodes.Status400BadRequest)]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status409Conflict)]
        public async Task<ActionResult<IFinalResult>> UpdateAsync([FromBody] AddGeoPointDto model, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await geoPointService.UpdateAsync(model, cancellationToken);
        ...
        {
            IFinalResult res = await geoPointService.DeleteAsync(id, cancellationToken);
        ...
        {
            IFinalResult res = await geoPointService.DeleteSoftAsync(id, cancellationToken);
