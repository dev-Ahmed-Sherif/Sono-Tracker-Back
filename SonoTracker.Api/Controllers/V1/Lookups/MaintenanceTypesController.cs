...
namespace SonoTracker.Api.Controllers.V1.Lookups
{
    ...
    public class MaintenanceTypesController(IMaintenanceTypeService maintenanceTypeService) : BaseController
    {
        ...
        public async Task<IFinalResult> GetAsync(string id, CancellationToken cancellationToken = default)
                                        => await maintenanceTypeService.GetByIdAsync(id, cancellationToken);
        ...
        public async Task<IFinalResult> GetEditAsync(string id, CancellationToken cancellationToken = default)
                                        => await maintenanceTypeService.GetByIdForEditAsync(id, cancellationToken);
        ...
        {
            IFinalResult res = await maintenanceTypeService.GetAllAsync(cancellationToken: cancellationToken);
            return Ok(res);
        }
        ...
        [HttpPost("getPaged")]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status200OK)]
        public async Task<ActionResult<PagingResult>> GetPagedAsync([FromBody] BaseParam<MaintenanceTypeFilter> filter, CancellationToken cancellationToken = default)
        {
            PagingResult res = await maintenanceTypeService.GetAllPagedAsync(filter, cancellationToken);
            return Ok(res);
        }
        ...
        public async Task<ActionResult<IFinalResult>> AddAsync([FromBody] AddMaintenanceTypeDto dto, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await maintenanceTypeService.AddAsync(dto, cancellationToken);
        ...
        {
            PagingResult res = await maintenanceTypeService.GetDropDownAsync(filter, cancellationToken);
            return Ok(res);
        }
        ...
        [ProducesResponseType<IFinalResult>(StatusCodes.Status400BadRequest)]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status409Conflict)]
        public async Task<ActionResult<IFinalResult>> UpdateAsync([FromBody] AddMaintenanceTypeDto model, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await maintenanceTypeService.UpdateAsync(model, cancellationToken);
        ...
        {
            IFinalResult res = await maintenanceTypeService.DeleteAsync(id, cancellationToken);
        ...
        {
            IFinalResult res = await maintenanceTypeService.DeleteSoftAsync(id, cancellationToken);
