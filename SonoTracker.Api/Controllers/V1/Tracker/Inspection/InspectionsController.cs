...
namespace SonoTracker.Api.Controllers.V1.Tracker.Inspection
{
    ...
    [Authorize]
    public class InspectionsController(IInspectionService inspectionService) : BaseController
    {
        /// <summary>
        /// Get By Id 
        /// </summary>
        ...
        {
            IFinalResult res = await inspectionService.GetAllAsync(cancellationToken: cancellationToken);
