...
namespace SonoTracker.Api.Controllers.V1.Tracker.FloatingUnit
{
    ...
    public class FloatingUnitOrganizationsController(IFloatingUnitOrganizationService floatingUnitOrganizationService) : BaseController
    {
        ...
        public async Task<IFinalResult> GetAsync(Guid id, CancellationToken cancellationToken = default)
                                        => await floatingUnitOrganizationService.GetByIdAsync(id, cancellationToken);
        ...
        public async Task<IFinalResult> GetEditAsync(Guid id, CancellationToken cancellationToken = default)
                                        => await floatingUnitOrganizationService.GetByIdForEditAsync(id, cancellationToken);
        ...
        [ProducesResponseType<IFinalResult>(StatusCodes.Status200OK)]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<PagingResult>> GetPagedAsync([FromBody] BaseParam<FloatingUnitOrganizationFilter> filter, CancellationToken cancellationToken = default)
        {
            PagingResult res = await floatingUnitOrganizationService.GetAllPagedAsync(filter, cancellationToken);
        ...
        public async Task<ActionResult<IFinalResult>> AddAsync([FromBody] AddFloatingUnitOrganizationDto dto, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await floatingUnitOrganizationService.AddAsync(dto, cancellationToken);
        ...
        [ProducesResponseType<IFinalResult>(StatusCodes.Status400BadRequest)]
        [ProducesResponseType<IFinalResult>(StatusCodes.Status409Conflict)]
        public async Task<ActionResult<IFinalResult>> UpdateAsync([FromBody] AddFloatingUnitOrganizationDto model, CancellationToken cancellationToken = default)
        {
            IFinalResult res = await floatingUnitOrganizationService.UpdateAsync(model, cancellationToken);
        ...
        {
            IFinalResult res = await floatingUnitOrganizationService.DeleteAsync(id, cancellationToken);
        ...
        {
            IFinalResult res = await floatingUnitOrganizationService.DeleteSoftAsync(id, cancellationToken);
