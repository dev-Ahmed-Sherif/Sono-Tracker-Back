...
{
    public interface IInspectionService : IBaseService<Entities.Tracker.Inspection, AddGeneralInspectionDto, EditGeneralInspectionDto, GeneralInspectionDto, string, string>
    {
